...
links:
  adr: ""
  repo-harvest: ""
superseded_by: "ADR-576-backup-classification"
---
# ADR-576-backup-strategy: Backup Strategy — Borg/Restic on Tier C (57-maintenance)

> **SUPERSEDED 2026-08-28 by ADR-576-backup-classification** (see docs/adr/ADR-576-backup-classification.md).
...
> a second external disk available), is captured in ADR-576-backup-classification together with the A1/A2/B/C
classification this repo now uses. Read ADR-576-backup-classification first; this file is historical context only.
