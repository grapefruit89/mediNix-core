...
- **Drop & Forget Compliance:** The entire landing page logic is firmly wrapped in a `config = lib.mkIf (config.grapefruitMedia.enable)` check, ensuring that it cleanly vanishes if the media stack is disabled.
