...
## Agent Routing Rule
> [!IMPORTANT]
> **Für alle LLMs / Agenten:** Bei Design-, Architektur- oder Implementierungsfragen liest du IMMER zuerst `docs/INDEX.md`. Der Index leitet dich zu den kanonischen Konzeptseiten und ADRs weiter.
